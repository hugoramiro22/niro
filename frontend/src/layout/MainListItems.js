  ...
  return (
    <li>
      <ListItem button component={renderLink}
        ...
        className={clsx(classes.menuItemContainer, drawerOpen ? '' : classes.menuItemContainer_open)}>
          ...
          <>
            ...
            {showCampaigns && (
              <>
                ...
                <Collapse
                  style={{ paddingLeft: (drawerOpen ? 15 : 30) }}
                ...
                >
                  <List component="div" disablePadding>
                    <ListItem
                      ...
                      <ListItemText  className={classes.menuItemText} primary="Listagem" />
                    </ListItem>
                    <ListItem
                      selected={"/contact-lists" === location.pathname} 
                      onClick={() => history.push("/contact-lists")}
                    ...
                    >
                      ...
                      <ListItemText className={classes.menuItemText} primary="Listas de Contatos" />
                    </ListItem>
                    <ListItem
                      selected={"/campaigns-config" === location.pathname} 
                      onClick={() => history.push("/campaigns-config")}
                    ...
                    >
                      ...
                      <ListItemText className={classes.menuItemText} primary="Configurações" />
                    </ListItem>
                  </List>
                </Collapse>
              </>
